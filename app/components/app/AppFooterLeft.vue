      ...
      <template #content>
        <div class="author-modal">
          ...
          <div class="author-modal__info">
            ...
            <div class="author-modal__socials">
              <a
